              ...
              <div className="widget widget-about">
                ...
                <div className="widget-body">
                  ...
                  <div className="social-icons social-icons-colored">
                    ...
                    <a
                      href="#"
                      className="social-icon social-youtube w-icon-youtube"></a>
                    <a
                      href="#"
                      className="social-icon social-pinterest w-icon-pinterest"></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="footer-bottom">
          ...
          <div className="footer-right">
            ...
            <figure className="payment">
              <img src={paymentLogo} alt="payment" width="159" height="25" />
            </figure>
          </div>
        </div>
      </div>
