...
import product2 from "../../../assets/images/products/default/2-800x900.jpg";
...
import product6 from "../../../assets/images/products/default/6-800x900.jpg";
import realated1 from "../../../assets/images/products/default/5.jpg";
import realated2 from "../../../assets/images/products/default/6.jpg";
import realated3 from "../../../assets/images/products/default/7-1.jpg";
import realated4 from "../../../assets/images/products/default/7-2.jpg";
import realated5 from "../../../assets/images/products/default/8.jpg";
                      ...
                      <div className="product-form product-variation-form product-color-swatch">
                        ...
                        <div className="d-flex align-items-center product-variations">
                          <a
                            href="#"
                            className="color"
                            style={{ backgroundColor: "#ffcc01" }}></a>
                          <a
                            href="#"
                            className="color"
                            style={{ backgroundColor: "#ca6d00" }}></a>
                          <a
                            href="#"
                            className="color"
                            style={{ backgroundColor: "#1c93cb" }}></a>
                          <a
                            href="#"
                            className="color"
                            style={{ backgroundColor: "#ccc" }}></a>
                          <a
                            href="#"
                            className="color"
                            style={{ backgroundColor: "#ccc" }}></a>
